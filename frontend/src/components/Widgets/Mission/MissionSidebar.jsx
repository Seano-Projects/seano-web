    ...
    >
      ...
      <div id="tour-mission-info" className="mb-6">
        ...
        <div className="bg-white dark:bg-black p-4 rounded-2xl border border-gray-200 dark:border-slate-600 space-y-3">
          ...
          {activeMission && (
            <div
              id="tour-mission-stats"
              className="pt-3 mt-3 border-t border-gray-200 dark:border-gray-600"
            >
      ...
      {showTourModal &&
        createPortal(
          <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl w-full max-w-md p-6 flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Untuk pengalaman tour yang lengkap, sebaiknya{" "}
                    <strong>muat misi terlebih dahulu</strong> agar semua
                    komponen dapat ditampilkan dengan benar.
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
                    Kamu tetap bisa melanjutkan tour tanpa misi, namun beberapa
                    langkah mungkin tidak dapat ditampilkan.
                  </p>
                </div>
              </div>
