      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Pilih panduan yang ingin kamu baca
          </p>
        </div>
      </div>

      <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 mt-4">
        SeaPortal menyediakan dokumentasi untuk pengguna, integrator, dan
        developer. Pilih salah satu kategori di bawah untuk memulai.
      </p>
        ...
        {CARDS.map(
          ({ icon: Icon, iconBg, label, desc, to, badge, badgeColor }) => (
            <button
              key={to}
              onClick={() => navigate(to)}
              className="w-full flex items-center gap-4 p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500 bg-white dark:bg-black hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-all text-left group"
            >
              <div
