    ...
    endpoints: [
      {
        ...
        auth: false,
        desc: "Daftarkan email baru untuk mendapatkan link verifikasi.",
      },
      {
        method: "POST",
        path: "/auth/verify-email",
        auth: false,
        desc: "Verifikasi email dengan token dari link.",
      },
      {
        method: "POST",
        path: "/auth/set-credentials",
        auth: false,
        desc: "Set password dan data akun setelah verifikasi email.",
      },
      {
        method: "POST",
      ...
      },
      {
        ...
        path: "/auth/login",
        auth: false,
        desc: "Login dan dapatkan access token + refresh token.",
      },
      {
        method: "POST",
        path: "/auth/refresh",
      ...
      },
      {
        ...
        path: "/auth/me",
        auth: true,
        desc: "Dapatkan data profil user yang sedang login.",
      },
      {
        method: "POST",
        path: "/auth/logout",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        auth: true,
        perm: "users.read",
        desc: "Daftar semua user.",
      },
      {
        method: "GET",
        path: "/users/:user_id",
        auth: true,
        desc: "Detail user berdasarkan ID.",
      },
      {
        method: "PUT",
        path: "/users/:user_id",
        auth: true,
        desc: "Update data user (ownership check).",
      },
      {
        method: "DELETE",
        path: "/users/:user_id",
    ...
    endpoints: [
      {
        ...
        path: "/vehicles",
        auth: true,
        desc: "Daftarkan kendaraan baru.",
      },
      {
        method: "GET",
        path: "/vehicles",
        auth: true,
        desc: "Daftar semua kendaraan milik user.",
      },
      {
        method: "GET",
        path: "/vehicles/connection-statuses",
        auth: true,
        desc: "Status koneksi MQTT (LWT) semua kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicles/:vehicle_id",
        auth: true,
        desc: "Detail kendaraan berdasarkan ID.",
      },
      {
        method: "PUT",
        path: "/vehicles/:vehicle_id",
        auth: true,
        desc: "Update data kendaraan.",
      },
      {
        method: "DELETE",
        path: "/vehicles/:vehicle_id",
        auth: true,
        desc: "Hapus kendaraan.",
      },
      {
        method: "POST",
        path: "/vehicles/:vehicle_id/api-key",
        auth: true,
        desc: "Generate API key per-kendaraan untuk autentikasi MQTT/HTTP.",
      },
      {
        method: "GET",
        path: "/vehicles/:vehicle_id/battery",
        auth: true,
        desc: "Status baterai terbaru kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicles/:vehicle_id/battery-logs",
        auth: true,
        desc: "Riwayat log baterai kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicle-batteries/latest",
        auth: true,
        desc: "Status baterai terbaru semua kendaraan.",
      },
      {
        method: "POST",
        path: "/vehicle-batteries",
        auth: "apikey",
        desc: "Kirim data baterai dari kendaraan (Vehicle API Key).",
      },
      {
        method: "POST",
        path: "/vehicle-status",
        auth: "apikey",
        desc: "Kirim status kendaraan dari perangkat (Vehicle API Key).",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        desc: "Buat tipe sensor baru.",
      },
      {
        method: "GET",
        path: "/sensor-types",
        auth: true,
        desc: "Daftar semua tipe sensor.",
      },
      {
        method: "GET",
        path: "/sensor-types/:sensor_type_id",
        auth: true,
        desc: "Detail tipe sensor.",
      },
      {
        method: "PUT",
        path: "/sensor-types/:sensor_type_id",
      ...
      },
      {
        ...
        auth: true,
        perm: "sensors.manage",
        desc: "Tambah sensor baru.",
      },
      {
        method: "GET",
        path: "/sensors",
        auth: true,
        desc: "Daftar semua sensor.",
      },
      {
        method: "GET",
        path: "/sensors/status",
        auth: true,
        desc: "Status semua vehicle-sensor.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        auth: true,
        desc: "Cari sensor berdasarkan kode.",
      },
      {
        method: "PUT",
        path: "/sensors/:sensor_id",
      ...
      },
      {
        ...
        auth: true,
        desc: "Pasangkan sensor ke kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicles/:vehicle_id/sensors",
        auth: true,
        desc: "Sensor yang dipasang di kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicles/:vehicle_id/sensors/status",
        auth: true,
        desc: "Status sensor di kendaraan.",
      },
      {
        method: "DELETE",
        path: "/vehicles/:vehicle_id/sensors/:sensor_id",
        auth: true,
        desc: "Lepaskan sensor dari kendaraan.",
      },
      {
        method: "PUT",
        path: "/vehicles/:vehicle_id/sensors/:sensor_id/status",
        auth: true,
        desc: "Update status sensor pada kendaraan.",
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        path: "/missions",
        auth: true,
        desc: "Daftar semua misi milik user.",
      },
      {
        method: "GET",
        path: "/missions/stats",
      ...
      },
      {
        ...
        auth: true,
        desc: "Daftar misi yang sedang berlangsung.",
      },
      {
        method: "GET",
        path: "/missions/:mission_id",
        auth: true,
        desc: "Detail misi berdasarkan ID.",
      },
      {
        method: "PUT",
        path: "/missions/:mission_id",
      ...
      },
      {
        ...
        auth: true,
        desc: "Upload waypoint misi ke kendaraan via MQTT.",
      },
      {
        method: "GET",
        path: "/missions/pending-upload",
        auth: "apikey",
        desc: "Dapatkan misi yang belum diupload (Vehicle API Key).",
      },
      {
        method: "PUT",
        path: "/missions/:id/progress",
        auth: "apikey",
        desc: "Update progres misi dari kendaraan.",
      },
      {
        method: "POST",
        path: "/missions/waypoint-reached",
        auth: "apikey",
        desc: "Notifikasi waypoint tercapai dari kendaraan.",
      },
      {
        method: "DELETE",
        path: "/missions/:mission_id",
    ...
    endpoints: [
      {
        ...
        path: "/sensor-logs",
        auth: true,
        desc: "Query log sensor (filter: vehicle_id, sensor_id, waktu).",
      },
      {
        method: "GET",
        path: "/sensor-logs/:id",
        auth: true,
        desc: "Detail log sensor.",
      },
      {
        method: "GET",
        path: "/sensor-logs/export",
        auth: true,
        desc: "Export log sensor ke CSV.",
      },
      {
        method: "POST",
        path: "/sensor-logs/import",
        auth: true,
        desc: "Import log sensor dari CSV.",
      },
      {
        method: "POST",
        path: "/sensor-logs",
        auth: "apikey",
        desc: "Kirim log sensor dari kendaraan.",
      },
      {
        method: "DELETE",
        path: "/sensor-logs/:id",
        auth: true,
        desc: "Hapus log sensor.",
      },
      {
        method: "GET",
        path: "/vehicle-logs",
        auth: true,
        desc: "Query log telemetri kendaraan (filter: vehicle_id, waktu).",
      },
      {
        method: "GET",
        path: "/vehicle-logs/:id",
        auth: true,
        desc: "Detail log telemetri.",
      },
      {
        method: "GET",
        path: "/vehicle-logs/latest/:vehicle_id",
        auth: true,
        desc: "Log telemetri terbaru kendaraan.",
      },
      {
        method: "GET",
        path: "/vehicle-logs/export",
        auth: true,
        desc: "Export log telemetri ke CSV.",
      },
      {
        method: "POST",
        path: "/vehicle-logs/import",
        auth: true,
        desc: "Import log telemetri dari CSV.",
      },
      {
        method: "POST",
        path: "/vehicle-logs",
        auth: "apikey",
        desc: "Kirim log telemetri dari kendaraan.",
      },
      {
        method: "DELETE",
        path: "/vehicle-logs/:id",
        auth: true,
        desc: "Hapus log telemetri.",
      },
      {
        method: "GET",
        path: "/raw-logs",
        auth: true,
        desc: "Query raw log (filter: search, waktu).",
      },
      {
        method: "GET",
        path: "/raw-logs/stats",
        auth: true,
        desc: "Statistik raw log.",
      },
      {
        method: "GET",
        path: "/raw-logs/export",
        auth: true,
        desc: "Export raw log ke CSV.",
      },
      {
        method: "POST",
        path: "/raw-logs/import",
        auth: true,
        desc: "Import raw log dari CSV.",
      },
      {
        method: "GET",
        path: "/raw-logs/:id",
      ...
      },
      {
        ...
        path: "/raw-logs",
        auth: "apikey",
        desc: "Kirim raw log dari kendaraan.",
      },
      {
        method: "DELETE",
        path: "/raw-logs/:id",
      ...
      },
      {
        ...
        path: "/logs/stats",
        auth: true,
        desc: "Statistik gabungan semua log.",
      },
      {
        method: "GET",
        path: "/logs/chart",
        auth: true,
        desc: "Data chart log untuk visualisasi.",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        path: "/alerts",
        auth: true,
        desc: "Daftar alert aktif (anti-theft, failsafe).",
      },
      ...
      },
      {
        ...
        path: "/notifications",
        auth: true,
        desc: "Daftar notifikasi user.",
      },
      {
        method: "PUT",
        path: "/notifications/:id/read",
        auth: true,
        desc: "Tandai notifikasi sebagai dibaca.",
      },
      {
        method: "PUT",
    ...
    endpoints: [
      {
        ...
        auth: true,
        desc: "Kirim perintah kendaraan via MQTT melalui backend.",
      },
      {
        method: "GET",
        path: "/commands/pending",
        auth: "apikey",
        desc: "Ambil perintah pending untuk kendaraan (vehicle API key melalui query).",
      },
      {
        method: "POST",
        path: "/command-acks",
        auth: "apikey",
        desc: "Kirim ACK perintah dari kendaraan ke backend.",
      },
      {
        method: "POST",
        path: "/waypoint-acks",
        auth: "apikey",
        desc: "Kirim ACK waypoint dari kendaraan ke backend.",
      },
      {
        method: "POST",
        path: "/thruster-commands",
        auth: true,
        desc: "Buat perintah thruster untuk kendaraan.",
      },
      {
        method: "GET",
        path: "/thruster-commands/pending",
        auth: "apikey",
        desc: "Polling perintah thruster untuk kendaraan.",
      },
      {
        method: "GET",
        path: "/command-logs",
        auth: true,
        desc: "Riwayat perintah yang dikirim ke kendaraan.",
      },
      {
        method: "GET",
        path: "/waypoint-logs",
        auth: true,
        desc: "Riwayat waypoint yang dicapai kendaraan.",
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        auth: true,
        perm: "permissions.manage",
        desc: "Assign permission ke role.",
      },
      {
        method: "DELETE",
        path: "/permissions/remove-from-role/:role_id/:permission_id",
        auth: true,
        perm: "permissions.manage",
        desc: "Hapus permission dari role.",
      },
    ],
  },
];
    ...
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-700 rounded-xl p-4 mb-6 text-sm">
        ...
        <div className="flex gap-4 mt-3 text-xs text-gray-500 flex-wrap">
          ...
          <span className="flex items-center gap-1">
            <FaLock className="text-blue-500 text-[10px]" /> API Key — vehicle
            key dari /vehicles/:id/api-key
          </span>
          <span className="flex items-center gap-1">
