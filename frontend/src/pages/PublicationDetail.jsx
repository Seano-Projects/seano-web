...
export default function PublicationDetail() {
  ...
  if (notFound || !pub) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <p className="text-gray-400">Publikasi tidak ditemukan.</p>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      >
        <FaArrowLeft size={12} /> Kembali ke Publikasi
      </Link>

      <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8 items-start">
        {/* ── Kolom kiri: cover PDF ── */}
        <div className="flex flex-col gap-3">
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden border border-gray-200 dark:border-slate-700 bg-slate-900 shadow-lg">
            {pdfUrl ? (
              ...
              <div className={`w-full h-full flex flex-col items-center justify-center gap-3 bg-linear-to-b ${typeBg[pub.type] ?? 'from-slate-700 to-slate-900'}`}>
                ...
                <span className="text-xs text-white/40">Tidak ada dokumen</span>
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {pub.doi && (
              ...
              >
                <FaExternalLinkAlt size={13} /> Lihat DOI / Link
              </a>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* Authors */}
          <div>
            <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Penulis</p>
          ...
          {pub.venue && (
            <div>
              <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Venue / Institusi</p>
          ...
          {pub.abstract && (
            <div>
              <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-2">Abstract</p>
